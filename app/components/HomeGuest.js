    ...
    switch (action.type) {
      case "usernameImmediately":
        ...
        if (draft.username.value.length > 30) {
          ...
          draft.username.message = "Username can only be 30 characters long"
        }
        if (
      ...
      case "usernameUniqueResults":
        if (action.value) {
          ...
          draft.username.message = "Username is already in use"
        } else {
      ...
      case "emailAfterDelay":
        if (!/^\S+@\S+$/.test(draft.email.value)) {
          ...
          draft.email.message = "Email must be valid"
        }
      ...
      case "passwordImmediately":
        ...
        if (draft.password.value.length > 50) {
          ...
          draft.password.message = "Password can only be 50 characters long"
        }
        return
